    ...
    return (
        <div className="flex flex-col items-center justify-center h-full space-y-8">
            ...
            >
                <div className={`relative w-full h-full transition-all duration-500 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
                    ...
                    <div className="absolute w-full h-full backface-hidden">
                        <PracticeCard className="h-full flex flex-col items-center justify-center p-8 text-center hover:shadow-xl hover:shadow-indigo-50/50 transition-all duration-300 relative group border-t-4 border-indigo-500">
                    ...
                    <div className="absolute w-full h-full backface-hidden rotate-y-180">
                        <PracticeCard className="h-full flex flex-col items-center justify-center p-8 text-center bg-slate-50 border-t-4 border-fuchsia-400">
                            <p className="text-xl text-slate-800 font-medium mb-6 leading-relaxed">{currentCard.definition}</p>
                            <div className="w-12 h-1 bg-indigo-200 rounded-full mb-6"></div>
                            <p className="text-lg text-slate-500 italic font-serif">"{currentCard.example}"</p>
            ...
            <div className="flex items-center gap-4">
                <button
                    onClick={handlePrev}
                    className="p-4 rounded-full bg-white border border-slate-200 text-slate-400 hover:bg-slate-50 hover:border-slate-300 hover:text-slate-600 transition-all shadow-sm hover:shadow-md"
                >
                        ...
                        className={`
                            ...
                            ${item.matched
                                ...
                                : selected === idx
                                    ...
                                    : 'bg-white border-slate-200 text-slate-700 hover:border-slate-300 hover:bg-slate-50 hover:shadow-md hover:-translate-y-1'}
                        `}
                    >
                        {item.content}
                    </button>
            ...
            <PracticeCard className="p-8 text-center relative border-t-4 border-indigo-500">
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 inline-block w-full max-w-2xl">
                    <p className="text-slate-600 text-lg leading-relaxed">
                        "{currentItem.example.replace(new RegExp(currentItem.word, 'gi'), '_____')}"
                    </p>
                </div>
            </PracticeCard>
