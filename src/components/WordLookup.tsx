...
import { lookupWord, translateText } from '../services/geminiClient';
    ...
    return (
        <div ref={containerRef}>
            ...
            {selection && createPortal(
                <div
                    className="word-lookup-tooltip fixed z-50 bg-slate-900 text-white rounded-lg shadow-xl px-4 py-2.5"
                    style={{
                ...
                >
                    {/* Arrow */}
                    <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-3 h-3 bg-slate-900 transform rotate-45" />
                    ...
                    {loading ? (
                        ...
                        <p className="text-sm leading-relaxed text-center">{definition}</p>
                    ) : null}
                </div>,
                document.body
            )}
