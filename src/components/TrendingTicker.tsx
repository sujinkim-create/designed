    ...
    return (
        <div className="w-full mt-16 mb-12 relative">
            ...
            <div className="relative overflow-hidden py-6">
                ...
                <div className="relative space-y-3" style={{ maskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)' }}>
