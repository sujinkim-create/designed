...
export const GrammarQuiz: React.FC<GrammarQuizProps> = ({ articleText, learningHistory }) => {
        ...
        if (!quizData) {
            ...
            try {
                const response = await fetch('/api/generate-grammar-quiz', {
                    ...
                    body: JSON.stringify({ articleText, learningHistory }),
                });
                ...
                console.error(err);
                alert(err.message); // Show specific error message (e.g., "No matching grammar points...")
                setIsOpen(false);
            } finally {
                setLoading(false);
            }
    ...
    if (!isOpen) {
        return (
            ...
            >
                ...
                <span>Start Personalized Quiz</span>
            </button>
        );
    }
            ...
            <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-in fade-in zoom-in duration-200">
                ...
                <div className="flex justify-between items-center p-6 border-b border-slate-100">
                    <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
                        ...
                        Personalized Grammar Challenge
                    </h3>
