...
import CollocationPractice from './CollocationPractice';
            ...
            <main className="flex-grow flex flex-col">
                {view === 'home' ? (
                    ...
                    <div className="flex flex-col md:flex-row h-[calc(100vh-5rem)] overflow-hidden">
                        ...
                        <aside className="hidden md:flex flex-col w-60 glass border-r border-white/20 p-5 shrink-0">
                            <div className="mb-6">
                      ...
                      `}
                        ...
                        {/* Mobile Nav Tabs */}
                        <div className="md:hidden fixed bottom-0 left-0 right-0 glass border-t border-white/20 z-50 flex justify-around p-2 pb-safe shadow-lg">
                            {[
                        ...
                        {/* Content Area */}
                        <div className="flex-grow overflow-y-auto p-4 md:p-10 pb-24 md:pb-10 w-full">
                                        ...
                                        <div>
                                            {isGeneratingStudy ? (
                                                ...
                                                <>
                                                    ...
                                                    {activeTab === 'grammar' && (
                                                        <GrammarPractice
                                                            grammarPoints={studyData.grammar}
                                                            articleText={articleData.variations[currentLevelIndex].content}
                                                            learningHistory={learningHistory}
                                                        />
                                                    )}
